# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 22:54:11 2019
...
# find avg minutes per visitor >15
print("\n****************", end='')
print('\n**** Average min/visit > 15:')
print(df[(df['Average Minutes per Visit'] > 15)])

# find avg daily visitors >50000
print("\n****************", end='')
print('\n**** Average Daily Visitors > 50000:')
print(df[(df['Average Daily Visitors (000)'] > 50000)])

# find avg min/visit <1 and average daily visitors >1000
print("\n****************", end='')
print('\n**** Visits greater than 1000 and Average Minutes per Visit <1:')
print(df[(df['Average Daily Visitors (000)'] > 1000) & (df['Average Minutes per Visit'] < 1)])